...
> 
> для корректной работы скрипта down_models необходимо указать api ключ из личного кабинета civitai внутри самого скрипта
>
...
cd tgbotcomf/ && tar -xf models_and_nodes.tar.xz && mv models/ custom_nodes/ down_models.sh video_generate.json ~/ComfyUI/
